...
$routes->get('/EstMat', 'EstMat::index');

$routes->get('/incremento', 'Empleado::incrementarSueldo');

$routes->get('/gastoDpto', 'Empleado::mostrarInfoDepto');

$routes->get('/inicio', 'Login::index');
...
$routes->add('filtrar', 'Reportes::filtrar');
